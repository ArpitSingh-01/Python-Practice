...
if x == 69 :
    print(f"{Your_Name} won no matter what because he choose best number in the universe 😏")
elif x<1:
    print(f"Be in your limts {Your_Name}")
elif y<1:
    print(f"Be in your limts {Your_Friend}")
elif x>10:
